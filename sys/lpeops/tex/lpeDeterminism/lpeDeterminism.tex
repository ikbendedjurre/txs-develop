...
\newcommand{\possibleSuccessors}[1]{\mathbf{psuccs}(#1)}
\newcommand{\filteredPossibleSuccessors}[2]{\mathbf{psuccs}_{#1}(#2)}
\newcommand{\nonDetSummands}[1]{\mathbf{nondet}(#1)}
\newcommand{\enabledSuccSpectrum}[1]{\mathbf{ESS}(#1)}
%----------------------------------------------------------
